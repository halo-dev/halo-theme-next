...
<@main useComment=false>
    ...
    <nav class="pagination">
        <#if posts.hasPrevious()>
            <#if posts.number == 1>
                <a class="extend prev" rel="prev" href="${options.blog_url!}/categories/${category.cateUrl}">
                    <i class="fa fa-angle-left" aria-label="Previous page"></i>
                </a>
            <#else>
                <a class="extend prev" rel="prev" href="${options.blog_url!}/categories/${category.cateUrl}/page/${posts.number}">
                    <i class="fa fa-angle-left" aria-label="Previous page"></i>
                </a>
            </#if>
        </#if>
        <#list rainbow as r>
            ...
            <#else>
                <a class="page-number" href="${options.blog_url!}/categories/${category.cateUrl}/page/${r}">${r}</a>
            </#if>
        </#list>
        <#if posts.hasNext()>
            <a class="extend next" rel="next" href="${options.blog_url!}/categories/${category.cateUrl}/page/${posts.number+2}/">
