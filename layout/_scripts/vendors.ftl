...
<script type="text/javascript" src="/${theme.folderName}/source/lib/jquery/index.js?v=2.1.3"></script>
<script type="text/javascript" src="/${theme.folderName}/source/lib/fastclick/lib/fastclick.min.js?v=1.0.6"></script>
...
<#if is_post?? || is_page??>
<script type="text/javascript" src="/${theme.folderName}/source/lib/jquery-toc/jquery.toc.min.js"></script>
<script type="text/javascript" src="/${theme.folderName}/source/lib/jquery-toc/toc.min.js"></script>
<script>
