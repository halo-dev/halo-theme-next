...
<script id="ribbon" type="text/javascript" size="${options.next_other_canvas_ribbon_size?default('300')}" alpha="${options.next_other_canvas_ribbon_alpha?default('0.6')}"  zIndex="${options.next_other_canvas_ribbon_zindex?default('-1')}" src="/${themeName}/source/lib/canvas-ribbon/canvas-ribbon.js"></script>
</#if>
