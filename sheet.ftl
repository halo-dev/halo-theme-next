...
<@html title="${post.title} | ${options.blog_title!'Next'}" keywords="${options.seo_keywords!'Next'}" desc="${options.seo_description!'Next'}" ogtype="article" url="${context!}/p/${post.url!}"></@html>
